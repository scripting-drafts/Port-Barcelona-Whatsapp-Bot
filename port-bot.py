    ...
    try:
        ...
        if id not in [*data]:
            if message.text.lower():
                ...
                data[id] = [str(id) + str(ids[x]).zfill(6)]
            ...
            if message.text.lower() in vIncidents[langs[id]] and message.text.lower() not in vIncidents[langs[id]][7] and bot_message == '':
            ...
            elif message.text.lower() == vIncidents[langs[id]][7] and bot_message == '':
                inc = vIncidents[langs[id]].index(message.text.lower())
                inc_type = vIncidents[1][vIncidents[langs[id]].index(message.text.lower())]
            ...
            try:
                ...
                print(data)
                response = requests.post('http://127.0.0.1:8000/input/' + id + '/', headers={ 'content-Type': 'application/json'}, data= '{"id":"' + data[id][0] + '", "inc_type":"' + data[id][2] + '", "inc_detail":"' + data[id][3] + '", "lat":"' + data[id][4] + '", "lon":"' + data[id][5] + '", "is_active":"True"}')
