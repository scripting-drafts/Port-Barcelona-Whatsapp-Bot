...
This is an abandoned prototype I kept developing after winning a contest with it. It could build a good source of data for a supervised training of a convolutional neural network in order to classify pictures depending on the current labels. It was tested on OS X 10.10.5. 
